...
public final class VelocityUtil {
	 ...
	 * @throws Exception
	 */
	public static void writeTemplateOutput(String templateName,
			String outputFile, Map<String, Object> map) throws Exception {
		try {
			...
			try {
				bw = new BufferedWriter(new OutputStreamWriter(
						new FileOutputStream(outputFile), "utf-8"), 1024 * 1024);
	...
	public static void main(String[] args) {
		...
		try {
			createHtml.writeTemplateOutput("RF.xml",
					"/home/zipe/test.xml", map);
			
			VelocityUtil createHtml2 = new VelocityUtil("/home/zipe/tmp");

			createHtml2.writeTemplateOutput("RF.xml",
					"/home/zipe/test2.xml", map);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
